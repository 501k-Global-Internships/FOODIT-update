      ...
      <div className="bg-white rounded-lg shadow-md p-4 border border-gray-200">
        ...
        {orderItems && name !== "Uche Ebuka" ? (
          <div>
            ...
            {isOpen && (
              <div className="absolute z-10 bg-gray-50 rounded-md p-2 shadow-lg w-full left-0 right-0">
                {orderItems.map((item, index) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-medium mx-4 bg-gray-200 px-2 py-1 rounded">
                      x{item.quantity}
                    </span>
        ...
        <div className="mt-4">
          <div className="flex items-center">
            ...
            <MapPinIcon className="w-5 h-5 text-[#2D60FF] mr-2" />
