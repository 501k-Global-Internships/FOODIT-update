...
const FaceRecognition = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <Navbar />
      <div className="flex-grow flex items-center justify-center px-4 py-12 sm:mt-10">
        <div className="container max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8">
          <div className="w-full md:w-1/2 max-w-md flex flex-col items-center">
            ...
            <div className="mb-6 flex flex-col items-center">
              <div
                className="w-[13rem] h-[13rem] rounded-full flex items-center justify-center cursor-pointer overflow-hidden"
