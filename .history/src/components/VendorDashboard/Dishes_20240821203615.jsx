  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main
          className={`flex-1 overflow-y-auto p-2 md:p-4 transition-all duration-300 ${
            isSidebarOpen ? "ml-64 md:ml-72" : "ml-0"
          }`}
          onClick={closeSidebar}
        >
          <div className="pt-2 md:pt-4">
            <div className="flex flex-col lg:flex-row p-2 md:p-4 space-y-2 lg:space-y-0 lg:space-x-2">
              {/* Add Dish Section */}
