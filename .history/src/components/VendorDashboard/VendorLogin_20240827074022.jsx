    ...
    >
      ...
      <div className="flex-grow flex items-center justify-center px-4 sm:px-8 py-12 mt-16">
        <div className="flex flex-col md:flex-row w-full max-w-5xl rounded-3xl overflow-hidden">
          <div className="w-full md:w-1/3 p-9 flex flex-col justify-center">
            <form className="space-y-4 max-w-md mx-auto">
              <div>
                ...
                <input
                  id="email"
                  type="email"
                  className="w-full px-4 py-3 bg-transparent border border-gray-300 rounded-lg text-white text-sm focus:outline-none focus:border-[#F6821F]"
                  required
                />
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-3 py-3 bg-transparent border border-gray-300 rounded-lg text-white text-sm focus:outline-none focus:border-[#F6821F]"
                  required
                />
                <button
                  type="button"
              ...
              <button
                type="submit"
                className="w-full bg-[#F6821F] text-white py-3 rounded-lg text-sm hover:bg-[#E57200] transition duration-300"
              >
                Login
              </button>
            </form>
