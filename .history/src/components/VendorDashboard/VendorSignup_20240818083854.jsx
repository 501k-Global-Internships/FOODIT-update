    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-grow flex flex-col md:flex-row items-center justify-between px-4 md:px-8 py-8 md:py-12">
        <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pr-8">
          <h2 className="text-3xl md:text-4xl font-bold text-[#F6821F] mb-4">Enter Vendors Name</h2>
          <p className="text-gray-600 mb-6">We would like to know the name of your Restaurant</p>
