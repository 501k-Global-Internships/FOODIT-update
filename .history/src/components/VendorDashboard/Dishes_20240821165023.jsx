...
const Dishes = () => {
  ...
  return (
    <main className="flex flex-col lg:flex-row p-6 bg-gray-50">
      <div className="flex flex-col items-center bg-gray-50 p-6 rounded-lg shadow-md w-full max-w-xs">
        ...
        <div className="w-40 h-40 bg-gray-200 border-dashed border-2 border-gray-400 rounded-lg flex items-center justify-center mb-4">
