...
const StatCard = ({ icon, title, value, iconColor }) => (
  <div className="bg-white p-4 rounded-lg shadow flex items-center">
    <div className={`rounded-full p-2 mr-4`} style={{ backgroundColor: iconColor }}>
      {icon}
    </div>
    <div>
      <div className="text-sm text-gray-600">{title}</div>
...
const OrdersTable = () => {
  const [orders, setOrders] = useState([
    { id: 1, orderNo: "#CM9801", clientName: "Katherine Moss", phoneNumber: "08134340384", address: "16, Musilicatu ayilas" },
    { id: 2, orderNo: "#CM9802", clientName: "John Doe", phoneNumber: "08134340385", address: "17, Example Street" },
    { id: 3, orderNo: "#CM9803", clientName: "Jane Smith", phoneNumber: "08134340386", address: "18, Sample Avenue" },
    { id: 4, orderNo: "#CM9804", clientName: "Bob Johnson", phoneNumber: "08134340387", address: "19, Test Road" },
  ]);
