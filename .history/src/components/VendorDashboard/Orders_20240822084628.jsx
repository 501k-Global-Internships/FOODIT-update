...
import Nav from "./Nav";
import { ChevronDownIcon, ChevronUpIcon, ClipboardCopyIcon, PhoneIcon } from "lucide-react";
      ...
      <div className="bg-white rounded-lg shadow-md p-4 border border-gray-200">
        ...
        {orderItems ? (
          <div>
            ...
            {isOpen && (
              <div className="absolute z-10 bg-white rounded-md p-2 shadow-lg w-full">
        ...
        <div className="mt-4">
          ...
          <div className="flex items-center">
            <LocationMarkerIcon className="w-5 h-5 text-[#2D60FF] mr-2" />
