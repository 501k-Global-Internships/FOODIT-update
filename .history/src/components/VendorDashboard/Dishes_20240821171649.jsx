    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex flex-1 justify-center p-6">
          <div className="flex flex-col lg:flex-row p-6 bg-gray-50 space-y-6 lg:space-y-0 lg:space-x-6">
            {/* Add Dish Section */}
            <div className="flex flex-col items-center p-6 rounded-lg w-full max-w-xs bg-white shadow-md">
            ...
            <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[...Array(4)].map((_, index) => (
                <div key={index} className="flex flex-col items-center p-4 relative bg-white shadow-md rounded-lg">
