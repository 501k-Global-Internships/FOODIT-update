  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden pt-16">
        ...
        <main
          className={`flex-1 overflow-y- p-4 transition-all duration-300 ${
            isSidebarOpen ? "md:ml-[]" : ""
          }`}
        >
...
const StatCard = ({ icon, title, value, change, bgColor }) => (
  <div className="bg-white p-3 rounded-lg shadow w-full max-w-[210px] lg:max-w-[230px] mx-auto h-[100px] flex flex-col justify-between">
