                ...
                <div className="relative mb-4">
                  <div className="w-32 h-32 mx-auto">
                    ...
                    <button
                      ...
                      className="absolute top-0 right-0 bg-white text-gray-600 p-1 rounded-full shadow-md"
                    >
                      <MoreVertical size={16} />
                    </button>
                  </div>
                  {activeMenu === index && (
                    <div className="absolute top-8 right-0 bg-white rounded-lg shadow-md z-10">
