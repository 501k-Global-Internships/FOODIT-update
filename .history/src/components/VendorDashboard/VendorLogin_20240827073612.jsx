  ...
  return (
    ...
    >
      ...
      <div className="flex-grow flex items-center justify-center px-4 sm:px-8 py-12 mt-16">
        <div className="flex flex-col md:flex-row w-full max-w-5xl rounded-3xl overflow-hidden bg-black bg-opacity-50">
          <div className="w-full md:w-21/3 p-8 flex flex-col justify-center">
