...
const MainContent = () => {
  return (
    <div className="space-y-6 mt-4 p-6 bg-gray-100">
    ...
    datasets: [
      {
        ...
        backgroundColor: (context) => {
          ...
          gradient.addColorStop(0, "#FFAB12"); // Solid color at the top
          gradient.addColorStop(0.5, "rgba(255, 255, 255, 0.11)"); // Transparent towards the bottom
