  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col overflow-hidden ">
        ...
        />
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6 py-[5.2rem] ml-0 md:ml-64">
  ...
  return (
    <div className="flex flex-col space-y-4">
      <div className="bg-white rounded-lg shadow-md p-4 border border-gray-200">
        ...
        {orderItems && name !== "Uche Ebuka" ? (
          <div className="relative">
            ...
            {isOpen && (
              <div
                className="absolute z-10 bg-white rounded-md p-2 shadow-lg w-full left-0 right-0"
      ...
      {status === "Pending" && accepted && (
        <button className="w-full bg-orange-500 text-white py-2 rounded-md text-sm font-medium hover:bg-orange-600">
          Accepted
        </button>
      )}
    </div>
