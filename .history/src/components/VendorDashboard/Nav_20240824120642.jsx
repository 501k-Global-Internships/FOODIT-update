import { MessageCircleIcon, MessagesSquareIcon, SearchIcon } from "lucide-react";
  ...
  return (
    <nav className="bg-white p-4 flex justify-between items-center fixed top-0 right-0 left-0 z-50 shadow-sm">
      ...
      <div className="flex items-center">
        ...
        <MessagesSquareIcon className="w-6 h-6 mr-4 cursor-pointer" />
        <IoNotificationsCircleOutline className="w-6 h-6 mr-4 cursor-pointer" />
        <MessageCircleIcon className="w-8 h-8 rounded-full cursor-pointer" />
      </div>
    </nav>
  );
};
