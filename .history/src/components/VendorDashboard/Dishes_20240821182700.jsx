    ...
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-6">
            {/* Add Dish Section */}
            <div className="flex flex-col items-center p-6 rounded-lg bg-white shadow-lg w-full max-w-xs">
            ...
            <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[...Array(4)].map((_, index) => (
                <div key={index} className="flex flex-col items-center p-4 relative bg-white shadow-lg rounded-lg">
      ...
      <div className="fixed top-4 right-4 space-y-2">
        {notifications.map((note, index) => (
          <div key={index} className="bg-black text-white p-2 rounded-lg flex items-center space-x-2">
            <span>{note}</span>
          </div>
        ))}
      </div>
