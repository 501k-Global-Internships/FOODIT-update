  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden pt-16">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-2 md:gap-4 lg:gap-0 lg:ml-[20rem]">
            <StatCard
              icon={<OrdersIcon />}
              title="Total Orders"
              value="1750"
...
const StatCard = ({ icon, title, value, change, bgColor }) => (
  <div className="bg-white p-3 rounded-lg shadow w-full max-w-[210px] lg:max-w-[230px] mx-aut h-[100px] flex flex-col justify-between">
