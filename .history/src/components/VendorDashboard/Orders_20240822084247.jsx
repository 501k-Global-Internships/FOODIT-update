          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-end mb-6">
              <div className="flex space-x-2">
                <span className="px-4 py-2 text-sm font-medium text-blue-600 bg-blue-100 rounded-full">Awaiting</span>
                <span className="px-4 py-2 text-sm font-medium text-yellow-600 bg-yellow-100 rounded-full">Pending</span>
                <span className="px-4 py-2 text-sm font-medium text-green-600 bg-green-100 rounded-full">Delivered</span>
              </div>
            </div>
