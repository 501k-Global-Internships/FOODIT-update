  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main
          className={`flex-1 overflow-y-auto p-4 md:p-6 sm:mt-6 transition-all duration-300 ${
            isSidebarOpen ? "ml-64" : ""
          }`}
          onClick={closeSidebar}
        >
          <div className="flex flex-col lg:flex-row p-6 bg-gray-50 space-y-6 lg:space-y-0 lg:space-x-0 lg:ml-[20rem]">
            {/* Add Dish Section */}
            <div className="flex flex-col items-center p-6 rounded-lg w-full max-w-xs">
              ...
              <div className="w-full border-dashed border-2 border-gray-400 rounded-lg flex flex-col items-center justify-between p-4 h-64">
                <h3 className="text-lg font-bold text-gray-700">Dish Name</h3>
                ...
                <h3 className="text-lg font-bold text-gray-700">₦ Price</h3>
              </div>
              <button
