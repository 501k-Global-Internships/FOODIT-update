...
const Dishes = () => {
  ...
  const [availability, setAvailability] = useState(true); // State to manage toggle switch
          ...
          <div key={index} className="p-4 relative">
            ...
            <div className="relative">
              <img
                src={Food}
                alt="Dish"
                className="w-48 h-48 object-cover rounded-lg" // Adjusted size and shape to square
              />
              <button
