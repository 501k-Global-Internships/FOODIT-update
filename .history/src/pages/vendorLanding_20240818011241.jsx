        ...
        >
          ...
          <div className="container mx-auto px- pt-24 md:pt-32">
            ...
            <div className="space-x-4">
              <Link t='/vendorLogin' className="bg-transparent border-2 border-[#F08F00] text-[#F08F00] px-6 py-2 rounded-full hover:bg-[#F08F00] hover:text-white transition duration-300">
                LOGIN
              </Link>
