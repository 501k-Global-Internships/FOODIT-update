...
const VendorLanding = () => {
    return (
      <div className="min-h-screen bg-black text-white font-sans">
        ...
        >
          <Navbar />
          <div className="container mx-auto px- pt-24 md:pt-32 lg:mddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd">
