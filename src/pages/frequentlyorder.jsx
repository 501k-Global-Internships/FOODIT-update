            ...
            >
              <div className="flex flex-col justify-center items-center">
                <p className="text-[#6E6B65] text-center font-mont font-normal text-[12px] relative top-14 rounded-[17px] w-[112px] h-[23px] bg-white place-content-center flex flex-row items-center">
                  <FaStar className="w-[13px] h-[13px] text-[#F08F00]" />
                  {item.address}
                </p>
                <img
                  src={item.imageUrl}
              ...
              <button
                ...
                className="bg-[#F08F00] w-[161px] h-[48px] text-white font-mont font-medium text-[18px] mb-7 rounded-[23px] flex flex-row items-center gap-1 place-content-center"
              >
                <FaPlus className="" />
                ADD TO CART
              </button>
