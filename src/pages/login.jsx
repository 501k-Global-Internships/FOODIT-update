            ...
            <form action="">
              ...
              <label htmlFor="" className="">
                ...
                <input
                  ...
                  className=" border-[1px] w-[456px] h-[60px] rounded-[600px] px-3 outline-none mb-5"
                />
              </label>
              ...
              <label htmlFor="">
                ...
                <input
                  ...
                  className="border-[1px] mb-5 w-[456px] h-[60px] rounded-[600px] px-3 outline-none"
                />
              </label>
              ...
              <div className="flex flex-col justify-center items-center pb-5">
                <NavLink
                  to=""
                  className="text-[#F6821F] font-medium font-mont text-[18px]"
                >
                  Forgotten Password
                </NavLink>
                <p className="text-black font-medium font-mont text-[18px]">
              ...
              <button
                ...
                className="w-[456px] h-[60px] rounded-[600px] text-white font-bold font-mont text-[18px] bg-[#F6821F] items-center"
              >
                Login
              </button>
            </form>
